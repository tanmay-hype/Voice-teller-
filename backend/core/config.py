...
class Settings(BaseSettings):
    ...
    # Database (keep external for Render PostgreSQL; override DATABASE_URL in Render env)
    POSTGRES_USER: str = "postgres"
    POSTGRES_PASSWORD: str = "postgres"
    POSTGRES_DB: str = "aivoice"
    DATABASE_URL: str = "postgresql+asyncpg://postgres:postgres@db:5432/aivoice"
    
    # Redis (use localhost for single-instance Render, redis:6379 for Docker Compose via env override)
    ...
    CORS_ORIGINS: str = "https://ai-voice-teller.netlify.app"
